...
class ClientApp:
    ...
    def disconnect_from_server(self):
        if self.connection:
            ...
            self.connection = None
            self.is_connected = False  # Cập nhật trạng thái kết nối
    ...
    def receive_screenshot(self, server_socket):
        try:
            ...
            raise  # Thêm raise để ném lỗi ra ngoài

    def receive_screenshots(self):
        self.is_connected = True  # Cập nhật trạng thái khi bắt đầu nhận ảnh chụp màn hình
        try:
            while self.is_connected:  # Sử dụng biến cờ
            ...
            print("Error in receive_screenshots:", e)
        finally:
